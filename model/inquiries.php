...
echo '<div class="col-12 col-sm-6 col-md-4 prfOpp" txid="'.$results['formid'].'">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    ...
                    <div class="col-5 text-center">
                      <img style="width:160px; height:140px" src="../../../solicitud-empleo/src/vistas/upload/'.$folder[0].'/'.$img.'" alt="" class="img-circle img-fluid">
                    </div>
                  </div>
                </div>
