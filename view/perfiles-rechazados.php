...
$_SESSION["pageBack"] = "perfiles-rechazados"; 
...
<div class="wrapper">
  <nav class="main-header navbar navbar-expand navbar-dark navbar-success">
    <ul class="navbar-nav">
      ...
      <li class="nav-item"><a class="nav-link" href="#"><i class="fas fa-ban"></i> Perfiles Rechazados </a></li>
    </ul>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item"><a href="perfiles-rechazados" class="nav-link active"><i class="nav-icon fas fa-ban"></i><p> Perfiles Rechazados</p></a></li>
...
$stmt2 = Conexion::conectar()->prepare("SELECT * FROM ".DB_SCHEMA.".applications WHERE formstatus = 2 ORDER BY fromdate DESC");
$stmt2 -> execute();
