...
<div class="col-12 row">
    <div class="col-4">
		 <div class="input-group mb-3">
		  ...
		  <input type="hidden" id="frloc" name="frloc" class="form-control" readonly  value="DO"/>
      </div>
    </div>    
	...
	<div class="col-4">
		 <div class="input-group mb-3">
          ...
          <input id="nid" name="nid" type="text" class="form-control" placeholder="Cedula" data-inputmask='"mask": "999-9999999-9"' data-mask />
      </div>
    </div>        
</div>
<div class="col-12 row">
	...
	<div class="col-4">
		 <div class="input-group mb-3">
          ...
          <input id="phone" name="phone" type="text" class="form-control" placeholder="Telefono" data-inputmask='"mask": "(999) 999-9999"' data-mask >
      </div>
    </div>	      
</div>
<div class="col-12 row">
	...
	<div class="col-4">
		 <div class="input-group mb-3">
          ...
          <input id="nac" name="nac" type="text" class="form-control" placeholder="Nacionalidad" value="Dominicana">
      </div>
    </div>        
</div>
<div class="col-12 row">
...
<thead>
	<tr>
		...
		<th><label> Cedula</label><input type="text" id="famId" class="form-control" placeholder="Documento de Identidad" data-inputmask='"mask": "999-9999999-9"' data-mask></th>
...
<thead>
	<tr>
		...
		<th><label> Desde </label><input type="text" id="acDtFrom" class="form-control" placeholder="Año" data-inputmask='"mask": "9999"' data-mask  /></th>
		<th><label> Hasta </label><input type="text" id="acDtTo" class="form-control" placeholder="Año" data-inputmask='"mask": "9999"' data-mask   /></th>
...
<thead>
		...
		<th><label> Telefono </label><input type="text" id="rlPhone" class="form-control" placeholder=""  data-inputmask='"mask": "(999) 999-9999"' data-mask/></th>
...
<option value="Superior Group 3">   Superior Group 3 </option> 
	...
	<div class="col-4">
		 <div class="input-group mb-3">
          ...
          <input id="emPhone" name="emPhone" type="text" class="form-control" placeholder="Telefono" data-inputmask='"mask": "(999) 999-9999"' data-mask>
      </div>
    </div>	
</div>
