        ...
        <div class="row">
		   ...
		   <input id="getCurrentCode" type="hidden" value="<?php echo $frmd; ?>"/>
		  	<div class="col-sm-6">
				...
				<a class="btn btn-default" href="" title="Editar Datos"><i class="fas fa-edit"></i> Editar </a>				
			 </div>						
...
<div class="row"><label class="col-sm-4 col-form-label">Dirección: </label><div class="col-sm-7 pt-2"><?php echo $frm_addr; ?>  </div></div>
