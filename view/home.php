    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item"><a href="home" class="nav-link active"><i class="nav-icon fas fa-home"></i><p> Inicio </p></a></li>
...
<h6 class="float-right">
    ...
    <div class="content">
      <div class="container-fluid">	
		<div class="row optionPane pt-3">
		
		
        

          <!-- /.col -->
          <div class="col-12 col-sm-6 col-md-3"  data-toggle="modal" data-target="#modal-default">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-success elevation-1"><i class="fas fa-folder-plus"></i></span>

              <div class="info-box-content">
                <span class="info-box-text"></span>
                <span class="info-box-number pt-3"> Nueva Solicitud </span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3 seletecOption" optUrl="solicitudes">
            <div class="info-box">
              <span class="info-box-icon bg-success elevation-1"><i class="fas fa-list"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">   </span>
                <span class="info-box-number pt-3">
          ...
          <!-- /.col -->
          <div class="col-12 col-sm-6 col-md-3 seletecOption" optUrl="perfiles-depurados">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-success elevation-1"><i class="fas fa-award"></i></span>

              <div class="info-box-content">
                <span class="info-box-text"></span>
                <span class="info-box-number pt-3">Aprobados</span> 
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <!-- /.col -->
		        ...
		        <!-- /.col -->
          <div class="col-12 col-sm-6 col-md-3 seletecOption" optUrl="ajustes">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-success elevation-1"><i class="fas fa-ban"></i></span>

              <div class="info-box-content">
                <span class="info-box-text"> </span>
                <span class="info-box-number pt-3"> Rechazados </span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
	  ...
	  <div class="card">
              <div class="card-header ui-sortable-handle" style="cursor: move;">
                <h3 class="card-title">
                  ...
                  Ultimas Solicitudes sin procesar 
                </h3>
...
$(".todo-list").on("click","li.appOp",function(){ 
	...
	location.href="index.php?ruta=perfil&code="+code;
});	
