...
$_SESSION["pageBack"] = "perfiles-depurados"; 
...
<div class="wrapper">
  <nav class="main-header navbar navbar-expand navbar-dark navbar-success">
    <ul class="navbar-nav">
      ...
      <li class="nav-item"><a class="nav-link" href="#"><i class="fas fa-award"></i> Perfiles Aprobados </a></li>
    </ul>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item"><a href="perfiles-depurados" class="nav-link active"><i class="nav-icon fas fa-award"></i><p> Perfiles Aprobados</p></a></li>
...
$stmt2 = Conexion::conectar()->prepare("SELECT * FROM ".DB_SCHEMA.".applications WHERE formstatus = 1 ORDER BY fromdate DESC");
$stmt2 -> execute();
